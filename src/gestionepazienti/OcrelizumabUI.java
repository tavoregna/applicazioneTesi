...
public class OcrelizumabUI extends javax.swing.JPanel {

    private PazienteUI parent;
    private int idOcrelizumab;
    ...
    public OcrelizumabUI(PazienteUI p,int id) {
        initComponents();
        cancellaOcrelizumab.setVisible(Opzioni.cancellaAttivo);
        idOcrelizumab=id;
        parent=p;
        aggiornaDatiOcrelizumab(idOcrelizumab);
        Utilita.undoAndRedo(this);
    }

    
    public void aggiornaDatiOcrelizumab(int id)
    {
         try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("SELECT * FROM Ocrelizumab WHERE ID_Ocrelizumab=?");
            pst.setInt(1,id);
    ...
    private void initComponents() {
        ...
        cancellaOcrelizumab = new javax.swing.JButton();
        ...
        cancellaOcrelizumab.setBackground(java.awt.Color.red);
        cancellaOcrelizumab.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        cancellaOcrelizumab.setText("X");
        cancellaOcrelizumab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cancellaOcrelizumabActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cancellaOcrelizumab)
                .addGap(19, 19, 19)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cancellaOcrelizumab, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(1, 1, 1)
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel17, jPanel5});

        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel5, jPanel3});
    ...
    private void noteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_noteFocusLost
        ...
        noteEdit=false;
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Note=? WHERE ID_Ocrelizumab=?");
    ...
    private void dataRMEncefaloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dataRMEncefaloActionPerformed
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Data_RM_Encefalica=? WHERE ID_Ocrelizumab=?");
    ...
    private void diarioClinicoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_diarioClinicoFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Diario_Clinico=? WHERE ID_Ocrelizumab=?");
    ...
    private void dataRMCervDorsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dataRMCervDorsActionPerformed
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Data_RM_Cervico_Dorsale=? WHERE ID_Ocrelizumab=?");
    ...
    private void piramidaleFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_piramidaleFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Piramidale=? WHERE ID_Ocrelizumab=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
    ...
    private void sensitivoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_sensitivoFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Sensitivo=? WHERE ID_Ocrelizumab=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void visivoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_visivoFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Visivo=? WHERE ID_Ocrelizumab=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void troncoEncFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_troncoEncFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Tronco_Enc=? WHERE ID_Ocrelizumab=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void cerebellareFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cerebellareFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Cerebellare=? WHERE ID_Ocrelizumab=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void sfintericheFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_sfintericheFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Sfinteriche=? WHERE ID_Ocrelizumab=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void cerebraleFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cerebraleFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Cerebrale=? WHERE ID_Ocrelizumab=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void deambulazioneFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_deambulazioneFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Deambulazione=? WHERE ID_Ocrelizumab=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void edssFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_edssFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET EDSS=? WHERE ID_Ocrelizumab=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private DefaultCategoryDataset datiGrafico()
    {
        ...
        //ResultSet rs=GestioneDatabase.querySelect("SELECT EDSS,Data FROM Ocrelizumab INNER JOIN DH_Standard ON ID_Ocrelizumab=ID_DH WHERE ID_Paziente="+Pazienti.getCurrID()+" ORDER BY Data ASC");
        ...
        ResultSet rs=GestioneDatabase.querySelect("SELECT EDSS,Data FROM (SELECT EDSS,Data FROM Ocrelizumab INNER JOIN DH_Standard ON ID_Ocrelizumab=ID_DH WHERE ID_Paziente="+Pazienti.getCurrID()+") UNION (SELECT EDSS,Data FROM Controllo_Standard WHERE ID_Paziente="+Pazienti.getCurrID()+") ORDER BY Data ASC");
        Date prev=null;
        int i=1;
        try {
            while(rs.next())
    ...
    private void esamiEmatoChimFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_esamiEmatoChimFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Esami_Ematochimici=? WHERE ID_Ocrelizumab=?");
    ...
    private void terSintoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_terSintoFocusLost
        ...
        terSintoEdit=false;
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Terapia_Sintomatica=? WHERE ID_Ocrelizumab=?");
    ...
    private void dataEsamEmatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dataEsamEmatoActionPerformed
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET Data_Esami_Ematochimici=? WHERE ID_Ocrelizumab=?");
    ...
    private void rmEncefalicaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_rmEncefalicaFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET RM_Encefalica=? WHERE ID_Ocrelizumab=?");
    ...
    private void esameObbNeuroFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_esameObbNeuroFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET EON=? WHERE ID_Ocrelizumab=?");
    ...
    private void rmCervDorsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_rmCervDorsFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Ocrelizumab SET RM_Cervico_Dorsale=? WHERE ID_Ocrelizumab=?");
    ...
    private void cancellaOcrelizumabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancellaOcrelizumabActionPerformed
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("DELETE FROM Ocrelizumab WHERE ID_Ocrelizumab=?");
            pst.setInt(1, idOcrelizumab);
            pst.executeUpdate();
    ...
    private javax.swing.JButton cancellaOcrelizumab;
