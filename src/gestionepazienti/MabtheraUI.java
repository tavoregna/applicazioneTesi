...
public class MabtheraUI extends javax.swing.JPanel {
    ...
    public MabtheraUI(PazienteUI p,int id) {
        initComponents();
    ...
    public void aggiornaDatiMabthera(int id)
    {
         try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("SELECT * FROM Mabthera WHERE ID_Mabthera=?");
            pst.setInt(1,id);
    ...
    private void initComponents() {
        ...
        cancellaMabthera = new javax.swing.JButton();
        ...
        cancellaMabthera.setBackground(java.awt.Color.red);
        cancellaMabthera.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        cancellaMabthera.setText("X");
        cancellaMabthera.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cancellaMabtheraActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cancellaMabthera, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(0, 0, 0)
    ...
    private void noteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_noteFocusLost
        ...
        noteEdit=false;
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Note=? WHERE ID_Mabthera=?");
            pst.setString(1,note.getText());
            pst.setInt(2, idMabthera);
            pst.executeUpdate();
        } catch (SQLException ex) {
    ...
    private void dataRMEncefaloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dataRMEncefaloActionPerformed
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Data_RM_Encefalica=? WHERE ID_Mabthera=?");
    ...
    private void diarioClinicoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_diarioClinicoFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Diario_Clinico=? WHERE ID_Mabthera=?");
    ...
    private void dataRMCervDorsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dataRMCervDorsActionPerformed
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Data_RM_Cervico_Dorsale=? WHERE ID_Mabthera=?");
    ...
    private void piramidaleFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_piramidaleFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Piramidale=? WHERE ID_Mabthera=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
    ...
    private void sensitivoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_sensitivoFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Sensitivo=? WHERE ID_Mabthera=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void visivoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_visivoFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Visivo=? WHERE ID_Mabthera=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void troncoEncFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_troncoEncFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Tronco_Enc=? WHERE ID_Mabthera=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void cerebellareFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cerebellareFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Cerebellare=? WHERE ID_Mabthera=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void sfintericheFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_sfintericheFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Sfinteriche=? WHERE ID_Mabthera=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void cerebraleFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cerebraleFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Cerebrale=? WHERE ID_Mabthera=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void deambulazioneFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_deambulazioneFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Deambulazione=? WHERE ID_Mabthera=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private void edssFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_edssFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET EDSS=? WHERE ID_Mabthera=?");
            if(val.length()==0)
            pst.setDouble(1,0);
            else
            pst.setDouble(1,Double.parseDouble(val));
    ...
    private DefaultCategoryDataset datiGrafico()
    {
        ...
        ResultSet rs=GestioneDatabase.querySelect("SELECT EDSS,Data FROM (SELECT EDSS,Data FROM Mabthera INNER JOIN DH_Standard ON ID_Mabthera=ID_DH WHERE ID_Paziente="+Pazienti.getCurrID()+") UNION (SELECT EDSS,Data FROM Controllo_Standard WHERE ID_Paziente="+Pazienti.getCurrID()+") ORDER BY Data ASC");
        Date prev=null;
        int i=1;
        try {
            while(rs.next())
    ...
    private void esamiEmatoChimFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_esamiEmatoChimFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Esami_Ematochimici=? WHERE ID_Mabthera=?");
    ...
    private void terSintoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_terSintoFocusLost
        ...
        terSintoEdit=false;
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Terapia_Sintomatica=? WHERE ID_Mabthera=?");
    ...
    private void dataEsamEmatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dataEsamEmatoActionPerformed
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET Data_Esami_Ematochimici=? WHERE ID_Mabthera=?");
    ...
    private void rmEncefalicaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_rmEncefalicaFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET RM_Encefalica=? WHERE ID_Mabthera=?");
    ...
    private void esameObbNeuroFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_esameObbNeuroFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET EON=? WHERE ID_Mabthera=?");
    ...
    private void rmCervDorsFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_rmCervDorsFocusLost
        ...
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("UPDATE Mabthera SET RM_Cervico_Dorsale=? WHERE ID_Mabthera=?");
    ...
    private void cancellaMabtheraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancellaMabtheraActionPerformed
        try {
            PreparedStatement pst=GestioneDatabase.preparedStatement("DELETE FROM Mabthera WHERE ID_Mabthera=?");
            pst.setInt(1, idMabthera);
            pst.executeUpdate();
    ...
    }//GEN-LAST:event_cancellaMabtheraActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton cancellaMabthera;
