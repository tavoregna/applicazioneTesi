...
public class Schede_DiagnosiUI extends javax.swing.JFrame {
     ...
     */
    /*public Schede_DiagnosiUI() {
        initComponents();
        this.setVisible(true);
    }*/

    public Schede_DiagnosiUI(int ID,PazienteUI p,int i) { //i=1 Vedi, i=2 Aggiungi
        initComponents();
        parent=p;
        pazID=ID;
